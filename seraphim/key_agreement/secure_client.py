...
class SecureClient(threading.Thread): 
    ...
    def run(self):
        ...
        while True:
            ...
            print("\033[1A%s%s%s@%s%s:%d%s: %s\033[K" % (Fore.RED, msg['author'], Fore.RESET, Fore.BLUE, self.sock.getsockname()[0], self.sock.getsockname()[1], Fore.RESET, keyAgreement.decrypt(msg['quote'])))
            print("%s%s%s@%s%s:%d%s: %s" % (Fore.RED, msg['author'], Fore.RESET, Fore.BLUE, self.sock.getsockname()[0], self.sock.getsockname()[1], Fore.RESET, msg['quote']))
            ...
            msg = self.receive()
            msg = json.loads(msg)
            print("%s%s%s@%s%s:%d%s: %s" % (Fore.RED, msg['author'], Fore.RESET, Fore.BLUE, host, port, Fore.RESET, msg['quote']))
            print("%s%s%s@%s%s:%d%s: %s" % (Fore.RED, msg['author'], Fore.RESET, Fore.BLUE, host, port, Fore.RESET, keyAgreement.decrypt(msg['quote'])))
